    ...
    user_options.extend(
        [
            (
                "cmake-args=",
                None,
                "extra CMake arguments passed on the cmake command line",
            )
        ]
    )
...
if __name__ == "__main__":
    ...
    if "test" not in sys.argv:
        EXT_MODULES = [
            CMakeExtension("MulticoreTSNE.MulticoreTSNE", sourcedir="multicore_tsne")
        ]
    setup(
        name=PACKAGE_NAME,
        version=VERSION,
        ...
        extras_require={"test": ["scikit-learn", "scipy"]},
